...
class Reported_CompletedViewController: UIViewController {
        ...
        AF.request(VALUNURL.myReportIssueURL, method: .get, headers: header)
            ...
            .responseDecodable(of: myReportIssueResponse.self) { [weak self] response in
                ...
                case .success(let response):
                    print(VALUNLog.debug("getMySolvedIssue-success"))
                ...
                case .failure(let error):
                    VALUNLog.error("getMySolvedIssue - err")
...
extension Reported_CompletedViewController: UITableViewDataSource, UITableViewDelegate{
