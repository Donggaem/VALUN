...
class Reported_SolvingViewController: UIViewController {
        ...
        AF.request(VALUNURL.myReportIssueURL, method: .get, headers: header)
            ...
            .responseDecodable(of: myReportIssueResponse.self) { [weak self] response in
                ...
                case .success(let response):
                    print(VALUNLog.debug("getMyPendingIssue-success"))
                ...
                case .failure(let error):
                    VALUNLog.error("getMyPendingIssue - err")
...
extension Reported_SolvingViewController: UITableViewDataSource, UITableViewDelegate{
