//
//  Solved_AllIssueViewControllerViewController.swift
//  VALUN
//
...
class Solved_AllIssueViewController: UIViewController {
   ...
   var categoryDictionary: Dictionary<String, String> = ["pet":"PET", "metal":"금속", "paper":"종이", "plastic":"플라스틱", "trash":"일반쓰레기", "styrofoam":"스티로폼", "glass":"유리", "garbage":"음식물 쓰레기", "waste":"폐기물", "lumber":"목재", "vinyl":"비닐", "etc":"기타"]
    ...
    private func getMyAllIssue_Sol() {
        AF.request(VALUNURL.mySoltionIssueURL, method: .get, headers: header)
            ...
            .responseDecodable(of: MySolutionIssueResponse.self) { [weak self] response in
                ...
                case .success(let response):
                    print(VALUNLog.debug("getMyAllIssue_Sol-success"))
                ...
                case .failure(let error):
                    VALUNLog.error("getMyAllIssue_Sol - err")
...
extension Solved_AllIssueViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if cell.issueStateLabel.text == "해결중" {
